...
/***/ "./src/modules/sendinformation.js":
/*!****************************************!*\
  !*** ./src/modules/sendinformation.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ getinformation)\n/* harmony export */ });\nasync function getinformation(name, scoreplayer) {\n  const url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/3Gp8KLZKuYejD2oYH5ly/scores';\n  const response = await fetch(url,\n    {\n      method: 'POST',\n      body: JSON.stringify({\n        user: name,\n        score: scoreplayer,\n      }),\n      headers: {\n        'Content-type': 'application/json; charset=UTF-8',\n      },\n    });\n  const data = await response.json();\n  return data;\n}\n\n//# sourceURL=webpack://leaderboard/./src/modules/sendinformation.js?");
